...
x <- read.csv("data/raw/fecundity.2022.csv")
...
x$vessel <- vessel(unique(x$vessel))
x$egg.colour <- egg.colour(x$egg.colour)
...
write.csv(x, file = "data/fecundity.2022.csv", row.names = FALSE)
